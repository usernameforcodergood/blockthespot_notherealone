...
# Define the new installation directory on the Desktop
$desktopPath = [System.IO.Path]::Combine([System.Environment]::GetFolderPath('Desktop'), 'SpotifyInstallation')

# Define paths for the Spotify executable and apps in the new directory
$spotifyDirectory = $desktopPath
...
if (-not (Test-Path -Path $spotifyDirectory)) {
    New-Item -Path $spotifyDirectory -ItemType Directory | Out-Null
}

Write-Host "Spotify will be installed to: $spotifyDirectory"
